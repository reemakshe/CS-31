// Reema Kshetramade
// SID 205328402
// Code for Project 1 - Logic Error
// Report poll results
...
int main()
{
    ...
    // Logic error: multiply by 100.0 at the end of the operation
    double pctFor = forImpeachment / numberSurveyed * 100.0;
    double pctAnti = antiImpeachment / numberSurveyed * 100.0;
